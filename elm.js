...
Elm.Main.make = function (_elm) {
   ...
   _P.incomingSignal(function (v) {
      return typeof v === "object" && "typ" in v && "label" in v && "x" in v && "y" in v && "player" in v && "n" in v ? {_: {}
                                                                                                                        ,typ: typeof v.typ === "string" || typeof v.typ === "object" && v.typ instanceof String ? v.typ : _U.badPort("a string",
                                                                                                                        v.typ)
                                                                                                                        ...
                                                                                                                        v.y)
                                                                                                                        ,player: typeof v.player === "object" && "typ" in v.player && "label" in v.player ? {_: {}
                                                                                                                                                                                                            ,typ: typeof v.player.typ === "string" || typeof v.player.typ === "object" && v.player.typ instanceof String ? v.player.typ : _U.badPort("a string",
                                                                                                                                                                                                            v.player.typ)
                                                                                                                                                                                                            ,label: typeof v.player.label === "string" || typeof v.player.label === "object" && v.player.label instanceof String ? v.player.label : _U.badPort("a string",
                                                                                                                                                                                                            v.player.label)} : _U.badPort("an object with fields \'typ\', \'label\'",
                                                                                                                        v.player)
                                                                                                                        ,n: typeof v.n === "number" ? v.n : _U.badPort("a number",
   ...
   _P.outgoingSignal(function (v) {
      return {typ: v.typ
             ...
             ,x: v.x
             ,y: v.y
             ,player: {typ: v.player.typ
                      ,label: v.player.label}
             ,n: v.n};
   }),
   A2($Signal._op["<~"],
   ...
   var main = function () {
      ...
      player) {
         return function () {
            ...
            var ktImg = function () {
               ...
               return $Debug.log("ktImg")($Basics.toString(kt));
            }();
            return A2($Basics._op["++"],
            "img/",
            A2($Basics._op["++"],
      ...
      var fromListListStateAtToElement = function ($) {
         return $Graphics$Element.flow($Graphics$Element.down)($List.map(function (cel) {
            return A2($Graphics$Element.flow,
            $Graphics$Element.right,
            A2($List.map,celToElement,cel));
         })($));
      };
      var boardToElement = function ($) {
         return $Graphics$Element.color($Color.green)(fromListListStateAtToElement(posKeyListTo2DList($)));
      };
